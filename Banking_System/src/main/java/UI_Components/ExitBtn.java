 ...
 * @author Manuel Marin
 */
public class ExitBtn extends RoundButton
{
   
    public ExitBtn(JFrame rootFrame, String text, Color defaultBackgroundColor, Color hoverBackgroundColor, Color clickBackgroundColor, Color defaultForegroundColor, Color hoverForegroundColor) {
